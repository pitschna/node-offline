...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\data\\codeCamp2015\\node-offline");
    parameters.put("artifactId","node-offline");
    parameters.put("outputDirectory","C:\\data\\codeCamp2015\\node-offline\\target\\classes");
    parameters.put("testOutputDirectory","C:\\data\\codeCamp2015\\node-offline\\target\\test-classes");
